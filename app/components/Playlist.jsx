...
const Playlist = ({}) => {
    const trackRefs = tracks.map(() => useRef(null));
                        ...
                        >
                            <div className="title-container relative flex items-center justify-start me-8 xl:w-[15rem]">
                                ...
                                >
                                    ...
                                    <div className="absolute top-0 left-0 z-10 flex items-center justify-center overflow-hidden ">
                                        {!waveSurferRefs[index]?.current?.isPlaying() ? (
                                            ...
                                            <img className="w-16 h-16 opacity-100" src={mediaIcons["pause"]} />
                                        )}
                                    </div>
                                </div>
                                <div className="flex items-start flex-col px-4 space-y-1 ">
                                    ...
                                    <a
                                        className="text-[0.65rem] border border-main rounded-md px-2 py-1 truncate"
                                        href=""
                                    >
                                        Dan Phillipson
                                    </a>
                            ...
                            >
                                <SoundWave
                                    ref={waveSurferRefs[index]}
                                    url={track}
                                    onFinish={() => handlePlayNext(index)}
                                />
                            </div>
